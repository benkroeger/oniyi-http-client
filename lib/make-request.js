  ...
  return new Promise((resolve, reject) =>
    requestPhaseList.run(ctx, (requestPhasesError) => {
      ...
      if (requestPhasesError) {
        ...
        if (requestPhasesError.response && requestPhasesError.response.fromCache) {
          debug('Cached data found with response: %o and body: %o', requestPhasesError.response, requestPhasesError.body); // eslint-disable-line max-len
