...
const displayPluginsLoadingTime = (hookState) => {
  ...
  logger.debug(`[${pluginsLoaded}] plugins loaded in ${timePicker(hookState.pluginsLoadingTime)}`);
};


module.exports = {
  parseUri,
  displayPluginsLoadingTime,
